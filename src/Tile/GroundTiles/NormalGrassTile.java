 ...
 * @author carlos
 */
public class NormalGrassTile extends Tile {
    
    public NormalGrassTile() {
        super();
    }
    
    @Override
    public void init(Vector2f position) {
        this.image = ImageLoader.loadImage("res/tiles/grass.png");
...
//            graphics.draw(square);
    ...
    public Tile cloneTile(Vector2f position) {
        NormalGrassTile tmpTile = new NormalGrassTile();
