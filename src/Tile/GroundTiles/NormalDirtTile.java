 ...
 * @author carlos
 */
public class NormalDirtTile extends Tile {
    
    public NormalDirtTile() {
        super();
    }
    
    @Override
    public void init(Vector2f position) {
        this.image = ImageLoader.loadImage("res/tiles/dirt.png");
...
//            graphics.draw(square);
    ...
    public Tile cloneTile(Vector2f position) {
        NormalDirtTile tmpTile = new NormalDirtTile();
