 ...
 * @author carlos
 */
public class NormalRoadTile extends Tile {
    
    public NormalRoadTile() {
        super();
    }
    
    @Override
    public void init(Vector2f position) {
        this.image = ImageLoader.loadImage("res/tiles/road.png");
...
//            graphics.draw(square);
    ...
    public Tile cloneTile(Vector2f position) {
        NormalRoadTile tmpTile = new NormalRoadTile();
